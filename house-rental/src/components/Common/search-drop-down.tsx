  ...
  return (
    <div className="mt-1 md:mt-0 p-4 shadow-sm border border-gray-300 rounded-lg flex flex-col items-start max-w-[1440px] mx-auto bg-white mb-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:space-x-4 w-full text-gray-600">
        <select className="border border-gray-200 w-full sm:w-1/3 h-8 transition-all duration-300 hover:border-primary">
        ...
        <select className="border p-0 border-gray-200 w-full sm:w-1/3 h-8 transition-all duration-300 hover:border-primary">
